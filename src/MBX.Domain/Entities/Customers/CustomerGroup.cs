...
public class CustomerGroup : BaseEntity
{
    [Required]
    [MaxLength(255)]
    public string GroupName { get; set; } = string.Empty; // Tên nhóm khách hàng (ví dụ: "VIP", "Sỉ", "Lẻ") (bắt buộc, độ dài tối đa 255 ký tự)

    [MaxLength(1000)]
    public string? Description { get; set; } // Mô tả nhóm khách hàng (không bắt buộc, độ dài tối đa 1000 ký tự)
