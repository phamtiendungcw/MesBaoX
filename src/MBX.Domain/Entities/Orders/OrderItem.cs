...
public class OrderItem : BaseEntity
{
    ...
    [Column(TypeName = "decimal(18, 2)")] public decimal Price { get; set; } // Giá sản phẩm tại thời điểm đặt hàng (bắt buộc, kiểu decimal với 2 số thập phân, quan trọng để lưu lại giá gốc khi có khuyến mãi)
    [MaxLength(255)] public string? ProductName { get; set; } // Tên sản phẩm (không bắt buộc, độ dài tối đa 255 ký tự, lưu lại để hiển thị thông tin đơn hàng ngay cả khi sản phẩm gốc bị thay đổi)
