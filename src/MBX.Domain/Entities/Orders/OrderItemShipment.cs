...
{
    [Required]
    public Guid ShipmentId { get; set; } // ID lô hàng (khóa ngoại đến bảng Shipment, bắt buộc)

    public virtual Shipment Shipment { get; set; } = null!; // Navigation property cho lô hàng (bắt buộc)

    [Required]
    public Guid OrderItemId { get; set; } // ID chi tiết đơn hàng (khóa ngoại đến bảng OrderItem, bắt buộc)
