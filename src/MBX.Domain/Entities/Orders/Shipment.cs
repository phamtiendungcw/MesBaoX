...
public class Shipment : BaseEntity
{
    ...
    [MaxLength(255)]
    public string? ShippingCarrier { get; set; } // Đơn vị vận chuyển (ví dụ: "Giao hàng nhanh", "VNPost") (không bắt buộc, độ dài tối đa 255 ký tự)

    [MaxLength(255)]
    public string? TrackingNumber { get; set; } // Mã vận đơn (không bắt buộc, độ dài tối đa 255 ký tự, dùng để theo dõi lô hàng)
