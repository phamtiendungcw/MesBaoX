...
public class Brand : BaseEntity
{
    [Required]
    [MaxLength(255)]
    public string BrandName { get; set; } = string.Empty; // Tên thương hiệu (bắt buộc, độ dài tối đa 255 ký tự)

    [MaxLength(1000)]
    public string? Description { get; set; } // Mô tả thương hiệu (không bắt buộc, độ dài tối đa 1000 ký tự)
