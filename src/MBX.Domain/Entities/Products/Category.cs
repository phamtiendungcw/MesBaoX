...
public class Category : BaseEntity
{
    [Required]
    [MaxLength(255)]
    public string CategoryName { get; set; } = string.Empty; // Tên danh mục (bắt buộc, độ dài tối đa 255 ký tự)

    [MaxLength(1000)]
    public string? Description { get; set; } // Mô tả danh mục (không bắt buộc, độ dài tối đa 1000 ký tự)
