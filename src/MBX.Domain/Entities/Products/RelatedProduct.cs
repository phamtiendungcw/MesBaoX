...
{
    [Required] public Guid ProductId { get; set; } // ID sản phẩm chính (khóa ngoại đến bảng Product, bắt buộc)
    ...
    [Required] public Guid RelatedToProductId { get; set; } // ID sản phẩm liên quan (khóa ngoại đến bảng Product, bắt buộc)
    ...
    [MaxLength(255)] public string? RelationType { get; set; } // Loại quan hệ (ví dụ: "Tương tự", "Mua kèm") (không bắt buộc, độ dài tối đa 255 ký tự)
}