...
using MBX.Domain.Entities.Sales;
...
public class Project : BaseEntity
{
    ...
    public Company Company { get; set; } = null!; // Công ty mà dự án thuộc về (Navigation)
    ...
    public User? ProjectManager { get; set; } // Người quản lý dự án (Navigation)
    public Guid? CustomerId { get; set; } // ID khách hàng (tùy chọn)
    public Customer? Customer { get; set; } // Khách hàng (Navigation)
    ...
    public SalesOpportunity? SalesOpportunity { get; set; } // Cơ hội bán hàng (Navigation)
