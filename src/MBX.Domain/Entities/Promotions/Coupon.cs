...
{
    [Required][MaxLength(255)] public string CouponCode { get; set; } = string.Empty; // Mã giảm giá (bắt buộc, độ dài tối đa 255 ký tự, duy nhất trong hệ thống)
    ...
    [Column(TypeName = "decimal(18, 2)")] public decimal DiscountValue { get; set; } // Giá trị giảm giá (bắt buộc, kiểu decimal với 2 số thập phân, tùy thuộc vào loại giảm giá)
