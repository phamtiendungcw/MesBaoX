...
public class OrderCoupon : BaseEntity
{
    ...
    [Required]
    public Guid CouponId { get; set; } // ID mã giảm giá (khóa ngoại đến bảng Coupon, bắt buộc)
    ...
    public decimal AppliedDiscountAmount { get; set; } // Giá trị giảm giá thực tế được áp dụng trong đơn hàng (nếu cần khác DiscountValue gốc của Coupon)
}