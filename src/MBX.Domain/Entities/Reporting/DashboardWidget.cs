...
{
    [Required] public Guid DashboardId { get; set; } // ID dashboard (khóa ngoại đến bảng Dashboard, bắt buộc)
    ...
    [MaxLength(50)] public string? WidgetType { get; set; } // Loại widget (ví dụ: "LineChart", "PieChart", "Statistic", "Table") (không bắt buộc, độ dài tối đa 50 ký tự)
