...
{
    [Required][MaxLength(255)] public string RoleName { get; set; } = string.Empty; // Tên vai trò (ví dụ: "Admin", "Quản lý sản phẩm", "Nhân viên bán hàng") (bắt buộc, độ dài tối đa 255 ký tự, duy nhất trong hệ thống)
    [MaxLength(1000)] public string? Description { get; set; } // Mô tả vai trò (không bắt buộc, độ dài tối đa 1000 ký tự)
